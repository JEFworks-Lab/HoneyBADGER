...
Leveraging both allele and expression information can improve power and allow us to identify potential copy-neutral LOHs. We can test regions identified by either the expression or allele-based HMMs using both expression and allele information. 
...
print(results)
## visualize as heatmap 
trees3 <- hb$visualizeResults(geneBased=TRUE, alleleBased=TRUE, details=TRUE, margins=c(25,15))

## order cells
hc3 <- trees3$hc
order3 <- hc3$labels[hc3$order]

hb$plotGexpProfile(cellOrder=order3) 
hb$plotAlleleProfile(cellOrder=order3) 
```
